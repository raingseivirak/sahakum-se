...
export default function EditService({ params }: EditServiceProps) {
  ...
  return (
    <div className={`space-y-4 ${fontClass}`}>
      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <div>
            ...
            <p className={`text-muted-foreground ${fontClass}`}>
              Update service configuration and multilingual content
            </p>
          </div>
        ...
        {/* Service Edit Form */}
        <EditServiceForm locale={params.locale} serviceId={params.id} />
      </div>
    </div>
  )
}
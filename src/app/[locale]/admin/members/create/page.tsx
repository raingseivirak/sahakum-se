...
export default function CreateMember({ params }: CreateMemberProps) {
  ...
  return (
    <div className={`space-y-4 ${fontClass}`}>
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage className={fontClass}>Add Member</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        <div className="flex items-center justify-between space-y-2">
          <div>
            ...
            <p className={`text-muted-foreground ${fontClass}`}>
              Register a new association member with their details
            </p>
          </div>
        ...
        {/* Member Form */}
        <MemberForm locale={params.locale} />
      </div>
    </div>
  )
}